...
__global__ void solveMomentumConservationEquationVelocityIntegrate(fluid f, solid s, interactionBase fluid2Fluid, interactionBase fluid2Solid, double3 g, double dt);
